            ...
            <div class="col-12">
                <el-tabs v-model="state.item.tabs" id="tabs-area">
                    ...
                    <el-tab-pane name="all">
                        ...
                        <table-auth-rules :params="state.params.all" v-on:refresh="method.refresh" ref="all"></table-auth-rules>
                    </el-tab-pane>
                    ...
                    <el-tab-pane name="remove">
                        ...
                        <table-auth-rules :params="state.params.remove" v-on:refresh="method.refresh" ref="remove" type="remove"></table-auth-rules>
                    </el-tab-pane>
...
const method = {
    ...
    type(type = 'default', name = '默认') {
        ...
        for (let item in state.params) {
            state.params[item].where = [['type', '=', type]]
        }
        // 指定刷新
        method.refresh('all','remove')
    },
