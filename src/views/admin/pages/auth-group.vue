            ...
            <div class="col-12">
                <el-tabs v-model="state.item.tabs" id="tabs-area">
                    ...
                    <el-tab-pane name="all">
                        ...
                        <table-auth-group :params="state.params.all" v-on:refresh="method.refresh" ref="all"></table-auth-group>
                    </el-tab-pane>
                    ...
                    <el-tab-pane name="remove">
                        ...
                        <table-auth-group :params="state.params.remove" v-on:refresh="method.refresh" ref="remove" type="remove"></table-auth-group>
                    </el-tab-pane>
...
import TableAuthGroup from '{src}/comps/table/auth-group.vue'
