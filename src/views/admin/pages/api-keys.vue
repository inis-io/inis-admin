            ...
            <div class="col-12">
                <el-tabs v-model="state.item.tabs" id="tabs-area">
                    ...
                    <el-tab-pane name="all">
                        ...
                        <table-api-keys :params="state.params.all" v-on:refresh="method.refresh" ref="all"></table-api-keys>
                    </el-tab-pane>
                    ...
                    <el-tab-pane name="remove">
                        ...
                        <table-api-keys :params="state.params.remove" v-on:refresh="method.refresh" ref="remove" type="remove"></table-api-keys>
                    </el-tab-pane>
