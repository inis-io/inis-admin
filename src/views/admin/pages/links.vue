            ...
            <div class="col-12">
                <el-tabs v-model="state.item.tabs" id="tabs-area">
                    ...
                    <el-tab-pane name="all">
                        ...
                        <table-links :params="state.params.all" v-on:refresh="method.refresh" ref="all"></table-links>
                    </el-tab-pane>
                    ...
                    <el-tab-pane name="remove">
                        ...
                        <table-links :params="state.params.remove" v-on:refresh="method.refresh" ref="remove" type="remove"></table-links>
                    </el-tab-pane>
