            ...
            <div class="col-12">
                <el-tabs v-model="state.item.tabs" id="tabs-area">
                    ...
                    <el-tab-pane name="all">
                        ...
                        <table-tags :params="state.params.all" v-on:refresh="method.refresh" ref="all"></table-tags>
                    </el-tab-pane>
                    ...
                    <el-tab-pane name="remove">
                        ...
                        <table-tags :params="state.params.remove" v-on:refresh="method.refresh" ref="remove" type="remove"></table-tags>
                    </el-tab-pane>
...
import TableTags from '{src}/comps/table/tags.vue'
