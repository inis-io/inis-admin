    ...
    <div class="container-fluid container-box">
        <div class="row d-none d-lg-flex">
            <div class="col-lg-6 d-flex">
                ...
                <button v-on:click="method.refresh()" class="btn btn-auto mx-1 mimic">刷新</button>
                <button v-on:click="method.add()" v-if="state.item.tabs.includes('all')" class="btn btn-auto ms-1 mimic">添加</button>
            </div>
            <div class="col-lg-6 d-flex justify-content-end" style="z-index: -1">
                <button class="btn btn-auto h-35px mimic" disabled="false">
                    {{ state.item.title }}
                </button>
            </div>
        </div>
