            ...
            <div class="col-12">
                <el-tabs v-model="state.item.tabs" id="tabs-area">
                    ...
                    <el-tab-pane name="all">
                        ...
                        <table-article-group :params="state.params.all" v-on:refresh="method.refresh" ref="all"></table-article-group>
                    </el-tab-pane>
                    ...
                    <el-tab-pane name="remove">
                        ...
                        <table-article-group :params="state.params.remove" v-on:refresh="method.refresh" ref="remove" type="remove"></table-article-group>
                    </el-tab-pane>
...
import TableArticleGroup from '{src}/comps/table/article-group.vue'
