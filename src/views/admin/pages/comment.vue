            ...
            <div class="col-12">
                <el-tabs v-model="state.item.tabs" id="tabs-area">
                    ...
                    <el-tab-pane name="all">
                        ...
                        <table-comment :params="state.params.all" v-on:refresh="method.refresh" ref="all"></table-comment>
                    </el-tab-pane>
                    ...
                    <el-tab-pane name="remove">
                        ...
                        <table-comment :params="state.params.remove" v-on:refresh="method.refresh" ref="remove" type="remove"></table-comment>
                    </el-tab-pane>
