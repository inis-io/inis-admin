                            ...
                            <div class="col-12">
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group">
                                        <input v-model="state.struct.value" type="text" class="form-control customize text-white" placeholder="为空自动生成32位密钥">
                                        <div class="input-group-append ms-2">
                                            <button v-on:click="method.rand()" class="btn btn-outline-light d-flex align-items-center text-white" type="button" style="height: 28px;">
                                                随机
                                            </button>
                                        </div>
                                    </div>
